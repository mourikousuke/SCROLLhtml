...
//			
//		}
		if(form.getPlaceinformation()!=null){
			
			String [] a = form.getPlaceinformation().split(",",0);
//			System.out.println(a[0]+"|"+a[1]);
			this.insertnewplace(item.getId(), a[0],a[1]);
		}
		else if(form.getInputplace()!=null){
		
			System.out.println(form.getInputplaceatt());
			this.insertnewplace(item.getId(),form.getInputplace(),form.getInputplaceatt());
		}
		else{
			
		}
//		System.out.println(form.getCurrent().getPlace()+form.getCurrent().getAttribute());
//		if(form.getCurrent()!=null){
//			this.insertnewplace(item.getId(), form.getCurrent().getPlace(),form.getCurrent().getPlaceattribute());
//			
//		}
	...
	private void insertnewplace(String id, String place, String placeattribute) {
		...
		this.itemDao2.insertplaceattribute(placeattributeid,placeid,placeattribute);
...
//	}
	...
	public List<JEWord> findJEword(String string) {
		// TODO Auto-generated method stub
		return this.itemDao2.getjeword(string);
	}

	public void setlogin(String id, Date date) {
		// TODO Auto-generated method stub
		this.itemDao2.setlogin(id,date);
	}

	public LoginConfirm getlogin(String id) {
		// TODO Auto-generated method stub
		return itemDao2.getlogin(id);
	}

	public void updatelogin(String id, Date date) {
		// TODO Auto-generated method stub
		this.itemDao2.updatelogin(id,date);
	}

	public List<LoginConfirm> getloginall(Date currentdate) {
		// TODO Auto-generated method stub
		return itemDao2.getloginall(currentdate);
	}

//	public List<MqQuiz> getgquiztime(String id) {
//		// TODO Auto-generated method stub
//		return itemDao2.getquiztime(id);
//	}

	public List<MqQuiz> getgquiztime(String id, Date d1, Date d2) {
		// TODO Auto-generated method stub
		return itemDao2.getquiztime(id,d1,d2);
//		}
	}

	public List<Results> question2(String id, String itemid) {
		// TODO Auto-generated method stub
		return this.itemDao2.questions2(id,itemid);
	}

	public List<Jplevelwords> getalljplevelwords(String id) {
		// TODO Auto-generated method stub
		return this.itemDao2.getalljpwords(id);
	}

	public List<Jplevelwords> gettoday(String id, Date todaytime) {
		// TODO Auto-generated method stub
		return this.itemDao2.gettodayword(id,todaytime);
	}

	public List<LoginConfirm> getAllcontext(String id) {
		// TODO Auto-generated method stub
		return this.itemDao2.getAllcontext(id);
	}

	public void createimportantlog(String id, String id2) {
		// TODO Auto-generated method stub
		this.itemDao2.insertimportance(KeyGenerateUtil.generateIdUUID(),id,id2);
	}


	public List<LoginConfirm> findimportnacelog(String id, String id2) {
		// TODO Auto-generated method stub
		return itemDao2.findimportantlog(id,id2);
	}

	public List<LoginConfirm> getimportance(String id) {
		// TODO Auto-generated method stub
		return itemDao2.getimportance(id);
	}


//
//	public void setquizans(String generateIdUUID, String quizid, String id,
//			String place, Date nowdate, String answerstate, String answertype) {
//		// TODO Auto-generated method stub
//		this.itemDao2.setquizans(generateIdUUID,quizid,id,place,nowdate,answerstate,answertype);
//	}

	public void setquizans(String generateIdUUID, String quizid, String itemid,
			String id, String place, Date nowdate, String answerstate,
			String answertype) {
		// TODO Auto-generated method stub
		this.itemDao2.setquizans(generateIdUUID,quizid,itemid,id,place,nowdate,answerstate,answertype);
	}

	public LoginConfirm getrealuser(String id) {
		// TODO Auto-generated method stub
		return itemDao2.getrealuser(id);
	}

	public List<LoginConfirm> getCyberdata(String real_goal) {
		// TODO Auto-generated method stub
		return itemDao2.getcyberdata(real_goal);
	}

	public LoginConfirm getquizmean(String itemid) {
		// TODO Auto-generated method stub
		return itemDao2.getquizmean(itemid);
	}

	public void updatechecklist(String id, String id2) {
		// TODO Auto-generated method stub
		itemDao2.updatecheck(id,id2);
	}

	public List<LoginConfirm> getchecklist(String id, String id2) {
		// TODO Auto-generated method stub
		return itemDao2.getchecklist(id,id2);
	}
