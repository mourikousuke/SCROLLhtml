...
//	List<String> findcount();
	...
	List<JEWord> getjeword(@Param("id")String string);

	void setlogin(@Param("id")String id,@Param("timer") Date date);

	LoginConfirm getlogin(@Param("id")String id);

	void updatelogin(@Param("userid")String id, @Param("timer")Date date);

	List<LoginConfirm> getloginall(@Param("timer")Date currentdate);


	List<MqQuiz> getquiztime(@Param("authorid")String id,@Param("d1") Date d1,@Param("d2")Date d2);

	List<Results> questions2(@Param("id")String id, @Param("itemid")String itemid);

	List<Jplevelwords> getalljpwords(@Param("id")String id);

	List<Jplevelwords> gettodayword(@Param("id")String id, @Param("todaytime")Date todaytime);

	List<LoginConfirm> getAllcontext(@Param("authorid")String id);

	void insertimportance(@Param("id")String generateIdUUID, @Param("itemid")String id, @Param("authorid")String id2);


	List<LoginConfirm> findimportantlog(@Param("itemid")String id, @Param("authorid")String id2);

	List<LoginConfirm> getimportance(@Param("id")String id);


	void setquizans(@Param("id")String generateIdUUID, @Param("myquizid")String quizid,@Param("itemid")String itemid, @Param("authorid")String id,
			@Param("place")String place, @Param("time")Date nowdate, @Param("answerstate")String answerstate, @Param("answertype")String answertype);

	LoginConfirm getrealuser(@Param("userid")String id);

	List<LoginConfirm> getcyberdata(@Param("level")String real_goal);

	LoginConfirm getquizmean(@Param("itemid")String itemid);

	void updatecheck(@Param("itemid")String id,@Param("userid") String id2);

	List<LoginConfirm> getchecklist(@Param("itemid")String id,@Param("userid") String id2);
