...
public class SettingForm implements java.io.Serializable {
    ...
    private String g_totaltime;
    
    private String g_onetime;
    
    private String g_totalword;
    
    private String g_oneword;
    
    private String inputplaceatt;
	...
	public String getG_totaltime() {
		return g_totaltime;
	}

	public void setG_totaltime(String g_totaltime) {
		this.g_totaltime = g_totaltime;
	}

	public String getG_onetime() {
		return g_onetime;
	}

	public void setG_onetime(String g_onetime) {
		this.g_onetime = g_onetime;
	}

	public String getG_totalword() {
		return g_totalword;
	}

	public void setG_totalword(String g_totalword) {
		this.g_totalword = g_totalword;
	}

	public String getG_oneword() {
		return g_oneword;
	}

	public void setG_oneword(String g_oneword) {
		this.g_oneword = g_oneword;
	}

	public String getInputplaceatt() {
		return inputplaceatt;
	}

	public void setInputplaceatt(String inputplaceatt) {
		this.inputplaceatt = inputplaceatt;
	}
