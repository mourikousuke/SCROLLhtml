...
public class ItemEditForm implements Serializable {
    ...
    private HashMap<String, HashMap<String,String>> map3 = new HashMap<String, HashMap<String,String>>();
    
    private LoginConfirm current;
   ...
   private String inputplaceatt;
	...
	public LoginConfirm getCurrent() {
		return current;
	}


	public void setCurrent(LoginConfirm current) {
		this.current.setPlace(current.getPlace());
		this.current.setAttribute(current.getAttribute());
		this.current = current;
	}

	public HashMap<String, HashMap<String,String>> getMap3() {
		return map3;
	}

	public void setMap3(HashMap<String, HashMap<String,String>> map3) {
		this.map3 = map3;
	}
