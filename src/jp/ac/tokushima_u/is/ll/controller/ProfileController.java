...
//    }
    ...
    public String ins(@ModelAttribute("form") ProfileEditForm form, BindingResult result, ModelMap model){
        Users user = userService.getById(SecurityUserHolder.getCurrentUser().getId());
      
        List<Groupmember> groupname = userService.getallgroupuser(user.getId());
        List<Groupmember> alluser = userService.getalluser();
        model.addAttribute("admingroup", groupname);
        model.addAttribute("adminall", alluser);
    	return "profile/ins";
    }
    
    @RequestMapping(value="/userquiz", method=RequestMethod.GET)
    public String ins2(@ModelAttribute("form") ProfileEditForm form, BindingResult result, ModelMap model, String studentid){
        Users user = userService.getById(SecurityUserHolder.getCurrentUser().getId());
      System.out.print(studentid);
        List<Groupmember> groupname = userService.getgroupquzi(studentid);
        if(form.getAge()!=null){
        groupname = userService.getgroupquzi(form.getAge());
        }
        model.addAttribute("quizdata", groupname);
        model.addAttribute("student", studentid);
        List<Groupmember> listgroup = new ArrayList<Groupmember>();
        if(form.getState()!=null && form.getType().equals("null") && form.getPlace().equals("null")){
        	System.out.println("Output");
        	System.out.println(form.getState());
        	System.out.println(groupname.size());
        	for(int i=0;i<groupname.size();i++){
        		if(groupname.get(i).getAnswerstate().equals(form.getState())){
        			
        			Groupmember g = new Groupmember();
        			g.setContent(groupname.get(i).getContent());
        			g.setPlace(groupname.get(i).getPlace());
        			g.setAnswerstate(groupname.get(i).getAnswerstate());
        			g.setAnswertype(groupname.get(i).getAnswertype());
        			g.setItemid(groupname.get(i).getItemid());
        			g.setAns(groupname.get(i).getAns());
        			g.setType(groupname.get(i).getType());
        			listgroup.add(g);
        			
        		}
        	}
        	  model.addAttribute("quizdata", listgroup);
        }
        
        else if( form.getType()!=null && form.getState().equals("null") && form.getPlace().equals("null")){
        	System.out.println("Output");
        	System.out.println(form.getState());
        	System.out.println(groupname.size());
        	for(int i=0;i<groupname.size();i++){
        		if(groupname.get(i).getAnswertype().equals(form.getType())){
        ...
        else if( form.getPlace()!=null && form.getState().equals("null") && form.getType().equals("null")){
        	System.out.println("Output");
        	System.out.println(form.getState());
        	System.out.println(groupname.size());
        	for(int i=0;i<groupname.size();i++){
        		if(groupname.get(i).getPlace().equals(form.getPlace())){
        ...
        else  if(form.getState()!=null && form.getType()!=null && form.getPlace().equals("null")){
        	System.out.println("Output");
        	System.out.println(form.getState());
        	System.out.println(groupname.size());
        	for(int i=0;i<groupname.size();i++){
        		if(groupname.get(i).getAnswerstate().equals(form.getState()) && groupname.get(i).getAnswertype().equals(form.getType()) ){
        ...
        else  if(form.getState()!=null && form.getPlace()!=null && form.getType().equals("null")){
        	System.out.println("Output");
        	System.out.println(form.getState());
        	System.out.println(groupname.size());
        	for(int i=0;i<groupname.size();i++){
        		if(groupname.get(i).getAnswerstate().equals(form.getState()) && groupname.get(i).getPlace().equals(form.getPlace()) ){
...
//        else if(form.getState()!=null && form.getPlace()!=null && form.getType()!=null){
//        	
//        	for(int i=0;i<groupname.size();i++){
//        		if(groupname.get(i).getAnswerstate().equals(form.getState()) && groupname.get(i).getPlace().equals(form.getPlace()) && groupname.get(i).getAnswertype().equals(form.getType())){
//        			
//        			Groupmember g = new Groupmember();
//        			g.setContent(groupname.get(i).getContent());
//        			g.setPlace(groupname.get(i).getPlace());
...
//        }
    	...
    	return "profile/quizuser";
    }
 
    @RequestMapping(value="/userquiz2", method=RequestMethod.GET)
    public String ins3(@ModelAttribute("form") ProfileEditForm form, BindingResult result, ModelMap model, String studentid){
        Users user = userService.getById(SecurityUserHolder.getCurrentUser().getId());
      System.out.print(studentid);
        List<Groupmember> groupname = userService.getgroupquzi(studentid);
        model.addAttribute("quizdata", groupname);
