    ...
    <c:url value="/usermessage/checkmessage" var="checkmessageuri" />
       ...
       $(function(){
            $(".userlink").contextMenu('context-menu-1', {
                ...
                'Send message': {
                    click: function(element){
                        $("<div id=\"usermsgdlg\" style=\"margin-left:1000px\">"
                        +"<div><form id=\"usermessageform\" action=\"#\" method=\"post\" style=\"margin-left:1000px\">"
                        +"<input id=\"umsg_sendto\" name=\"umsg_sendto\" type=\"hidden\" value=\""+$(element).attr("data-uid")+"\" />"
                        +"<textarea id=\"umsg_content\" name=\"content\" style=\"width:1000px;height:100%;\" rows=\"5\"></textarea>"
