...
<body>
	...
	<div id="NetworkContainer">
		...
		<ul class="nav nav-tabs">
			...
			<li><a href="/learninglog/analysis#sigma-example-parent2"
				data-toggle="tab" onClick="Displayshow(0)">KAL based on BUA</a></li>
			...
			<li style="margin-left: 10px;"><form:select path="analysisalgo"
					cssStyle="width:100%" style="margin-left:30px;">
		...
		<div id="LayoutTask" class="Layout">
			<div id="Center">
					...
					<div class="control-panel" style="width: 900px; height: 1px">
						...
						<div class="move" style="margin-top: -80px; position: absolute">
							<div class="contains-icon move-icon" tabindex="0" action="up"
								title="Move up in the graph" style="background-color: #D9E5FF">
								<div class="icon-button icon-arrow-up"
									style="background-color: #D9E5FF"></div>
							</div>
							<div class="contains-icon move-icon" tabindex="0" action="left"
								title="Move left in the graph" style="background-color: #D9E5FF">
								<div class="icon-button icon-arrow-left"
									style="background-color: #D9E5FF"></div>
							</div>
							<div class="contains-icon move-icon" tabindex="0" action="right"
								title="Move right in the graph"
								style="background-color: #D9E5FF">
								<div class="icon-button icon-arrow-right"
									style="background-color: #D9E5FF"></div>
							</div>
							<div class="contains-icon move-icon" tabindex="0" action="down"
								title="Move down in the graph" style="background-color: #D9E5FF">
								<div class="icon-button icon-arrow-down"
									style="background-color: #D9E5FF"></div>
							</div>
						</div>
						<div class="zoom" style="margin-top: -80px">
							<div class="contains-icon zoom-icon" tabindex="0" action="out"
								title="Zoom out the graph" style="background-color: #D9E5FF">
								<div class="icon-button icon-zoom-out"
									style="background-color: #D9E5FF"></div>
							</div>
							<div class="contains-icon" tabindex="0" action="refresh"
								title="Reset graph position" style="background-color: #D9E5FF">
				...
				<div class="span12 sigma-parent2" id="sigma-example-parent2"
					style="width: 900px">
							...
							<table style="line-height: 1.33em; border-collapse: collapse;"
								...
								<tbody>
									<tr>
										...
										<c:forEach begin="0" end="0" step="1" var="je"
											varStatus="status" items="${betweenness.je}">

											<c:choose>
												<c:when test="${not empty je.image}">
													<td rowspan="3"><img alt=""
														src="${staticserverUrl}/${projectName}/${je.image}_320x240.png"
														width="140px" height="140px" />&nbsp;</td>
												</c:when>
												<c:otherwise>
													<td rowspan="3"><img width="40px" height="40px" alt=""
														src="<c:url value="/images/no_image.gif" />" /> &nbsp;</td>
												</c:otherwise>
											</c:choose>
										</c:forEach>
										<c:forEach begin="0" end="0" step="1" var="na"
											varStatus="status" items="${betweenness.je}">
											<td>Author name</td>
											<td>${na.nickname}</td>
									...
									<tr>
										<td>Log infromation</td>
										<c:forEach begin="0" end="2" step="1" var="je"
											varStatus="status" items="${betweenness.je}">
											<table>
												<td>${je.content}</td>
 ...
 -->
			...
			<div id="Right2">
				<ul class="nav nav-tabs" style="width: 440px">
					...
					<li><a href="/learninglog/analysis#test" data-toggle="tab"
						onClick="Displayshow(101)">Recommendation</a></li>
					<li><a class="addlink" href="<c:url value="/item/add"/>"
						id="nextpage">Add new object</a></li>
							...
							<div class="panel-body">
								<table style="width: 100%">
									...
									<tbody>
										<c:url value="/analysis/kal" var="itemUrl" />
										<tr>
											<b><u>Native Language</u></b>
										</tr>
										<tr class="even">
											<td style="margin-right: 20px; width: 140px"><c:url
													value="/analysis/topdown" var="itemUrl" /> <form:form
													commandName="analysisCond" action="${itemUrl}"
													method="post" enctype="multipart/form-data"
													style="margin:0px;">
													<c:forEach items="${nationalitycounter}" var="obj"
														varStatus="status">
														<c:if test="${status.index == '11'}"></td>
											<td style="margin: 0px; width: 140px"></c:if> <c:if
													test="${status.index == '22'}"></td>
											<td style="margin: 0px; width: 140px"></c:if> <form:checkbox
													path="nationality" value="${obj.name}" checked="checked" />${obj.name}
												(${obj.total})<br> </c:forEach> <!--  			
										...
										<tr class="odd">
											...
											<td><form:checkbox path="gender" value="man" />Man<br>
										...
										<tr class="odd">
											<td><b><u>Age</u></b></td>
											<td><br> <form:checkbox path="age" value="10" />10~20<br>
												<form:checkbox path="age" value="20" />20~30<br> <form:checkbox
													path="age" value="30" />30~40<br> <form:checkbox
													path="age" value="40" />40~50<br> <form:checkbox
													path="age" value="50" />50~60<br></td>
										</tr>

										<tr class="odd">
											<td><b><u>Knowledge</u></b></td>
											<td><br> <c:forEach items="${poscounter}"
													var="posobj" varStatus="status">
										...
										<tr class="odd">
											<td><b><u>Place</u></b></td>
											<td><br> <form:checkbox path="place"
													value="amusement_park" />amusement park<br> <form:checkbox
													path="place" value="bakery" />bakery<br> <form:checkbox
													path="place" value="bank" />bank<br> <form:checkbox
													path="place" value="bar" />bar<br> <form:checkbox
													path="place" value="beauty_salon" />beauty_salon<br>
												<form:checkbox path="place" value="book_store" />book_store<br>
												<form:checkbox path="place" value="bus_station" />bus_station<br>
												<form:checkbox path="place" value="cafe" />cafe<br> <form:checkbox
													path="place" value="car_dealer" />car_dealer<br> <form:checkbox
													path="place" value="car_repair" />car_repair<br> <form:checkbox
													path="place" value="church" />church<br> <form:checkbox
													path="place" value="convenience_store" />convenience_store<br>
												...
												<form:checkbox path="place" value="food" />food<br> <form:checkbox
													path="place" value="gas_station" />gas_station<br> <form:checkbox
													path="place" value="grocery_or_supermarket" />grocery_or_supermarket<br>
												<form:checkbox path="place" value="hair_care" />hair_care<br>
												<form:checkbox path="place" value="hardware_store" />hardware_store<br>
											</td>
											<td><form:checkbox path="place" value="health" />health<br>
												...
												<form:checkbox path="place" value="park" />park<br> <form:checkbox
													path="place" value="pet_store" />pet_store<br> <form:checkbox
													path="place" value="pharmacy" />pharmacy<br> <form:checkbox
													path="place" value="post_office" />post_office<br> <form:checkbox
													path="place" value="restaurant" />restaurant<br> <form:checkbox
													path="place" value="school" />school<br> <form:checkbox
													path="place" value="shopping_mall" />shopping_mall<br>
										...
										<tr class="odd">
											...
											<td><br> <form:radiobutton path="layouttype"
													value="Random" checked="checked" />Random<br> <form:radiobutton
													path="layouttype" value="Yifan" />Yifan<br></td>
										</tr>

										<tr class="even" style="margin: 0px;">
											<td style="margin: 0px;"><br>
												<div class="operation" style="margin: 0px;">
													<ul class="moreInfo button" style="margin: 0px;">
														<li><input type="submit"
															class="btn btn-block btn-primary" value="Analysis"
															style="margin: 0px;" /></li>
						...
						<div id="kalchange1" class="panel-collapse collapse in">
							<div class="panel-body">
								...
								<c:forEach begin="0" end="29" step="1" var="betweenness"
									...
									<a href="<c:url value="/item/${betweenness.id}"/>">${status.index+1}.
										${betweenness.content}
										(importance:${betweenness.r_betweenness})</a>
									<br>

								</c:forEach>
								<br> <span class="label label-info">Logs of Shortest
									path</span><br>
								<c:forEach begin="0" end="29" step="1" var="betweenness"
									varStatus="status" items="${closeness_recommendation}">

									<a href="<c:url value="/item/${betweenness.id}"/>">${status.index+1}.
										${betweenness.content} (importance:${betweenness.r_clossness})</a>
									<br>

								</c:forEach>
								<br> <span class="label label-info">Important logs
									among learners</span><br>
								<c:forEach begin="0" end="29" step="1" var="betweenness"
									varStatus="status" items="${degree_recommendation}">

									<a href="<c:url value="/item/${betweenness.id}"/>">${status.index+1}.
										${betweenness.content} (importance:${betweenness.r_degree})</a>
									<br>

								</c:forEach>
								<br> <span class="label label-info">Important and
									common logs among learners</span><br>
								<c:forEach begin="0" end="29" step="1" var="betweenness"
									varStatus="status" items="${original_tecommendation}">

									<a href="<c:url value="/item/${betweenness.id}"/>">${status.index+1}.
										${betweenness.content}
										(importance:${betweenness.new_algorithm})</a>
									<br>
									...
									<table style="line-height: 1.33em; border-collapse: collapse;"
										...
										<tbody>
											<tr>
													...
													<c:choose>
														<c:when test="${not empty betweenness.itemtime}">
															<td rowspan="5"><img alt=""
																src="${staticserverUrl}/${projectName}/${betweenness.itemtime}_320x240.png"
																style="width: 80px; height: 80px" />&nbsp;</td>
														</c:when>
														<c:otherwise>
															<td rowspan="5"><img width="80px" height="80px"
																alt="" src="<c:url value="/images/no_image.gif" />" />
																&nbsp;</td>
														</c:otherwise>
													</c:choose>
													...
													<td>Author:${betweenness.nickname}</td>
											...
											<tr>
													...
													<td>Title:${betweenness.content}</td>
											

											</tr>
											<tr>
											
													<td>Place:&nbsp;${betweenness.placename}
											...
											<tr>
											<td>(importance:${betweenness.new_algorithm})</td>
											</tr>
